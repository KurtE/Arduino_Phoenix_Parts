...
#define cLFCoxaPin      9   //Front Left leg Hip Horizontal
#define cLFFemurPin     10   //Front Left leg Hip Vertical
#define cLFTibiaPin     11   //Front Left leg Knee
//#define cLFTarsPin      19   // Tar

#define cLMCoxaPin      12   //Middle Left leg Hip Horizontal
#define cLMFemurPin     13   //Middle Left leg Hip Vertical
#define cLMTibiaPin     14   //Middle Left leg Knee
//#define cLMTarsPin      23   // Tar

#define cLRCoxaPin      15   //Rear Left leg Hip Horizontal
