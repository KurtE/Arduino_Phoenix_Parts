...
#define cRROffsetX      -52     //Distance X from center of the body to the Right Rear coxa
...
#define cLROffsetX      52      //Distance X from center of the body to the Left Rear coxa
